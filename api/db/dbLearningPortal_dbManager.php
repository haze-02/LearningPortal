...
function getConnection() {
	...
	global $db_LearningPortal_db_Url, $db_LearningPortal_db_User, $db_LearningPortal_db_Pass, $db_LearningPortal_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_LearningPortal_db_Url.";dbname=".$db_LearningPortal_db_DbName, $db_LearningPortal_db_User, $db_LearningPortal_db_Pass);
